...
public class AuthenticationController : ApiController
{
    ...
    /// <summary>
    /// Authenticate with existing user using JwtTokens
    /// </summary>
    /// <param name="request"></param>
    ...
    public async Task<IActionResult> Login(LoginRequest request)
    {
        ...
        var nameClaim = new Claim(ClaimTypes.GivenName, user.Firstname);
        ...
        var claimsIdentity = new ClaimsIdentity(new[] {nameClaim, emailClaim, userIdClaim}, "serverAuth");
    ...
    /// <response code="200">Returns the authenticated user with the claimtypes</response>
    [HttpGet("me")]
    [ProducesResponseType(typeof(AuthenticationResponse), StatusCodes.Status200OK)]
    public async Task<IActionResult> Me()
    {
        ...
        var query = _mapper.Map<MeQuery>((userEmail, givenName, userId));
