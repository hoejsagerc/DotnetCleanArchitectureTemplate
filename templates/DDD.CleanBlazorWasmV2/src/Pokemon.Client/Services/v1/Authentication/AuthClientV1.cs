...
public class AuthClientV1 : IAuthClient
{
    ...
    public async Task<ServiceResponse<AuthenticationResponse>> LoginAsync(LoginRequest body)
    {
        ...
        try {
            ...
            try
            {
                ...
                {
                    serviceResponse.StatusCode = status;
                    serviceResponse.Message = response_.ReasonPhrase;
                }
                else {
                    serviceResponse.StatusCode = status;
    ...
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/auth/me");
    ...
    public async Task<ServiceResponse<AuthenticationResponse>> RefreshTokenAsync(RefreshTokenRequest body)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/auth/refresh");
