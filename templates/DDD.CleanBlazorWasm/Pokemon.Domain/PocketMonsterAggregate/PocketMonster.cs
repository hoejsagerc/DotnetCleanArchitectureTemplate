...
using Pokemon.Domain.PocketMonsterAggregate.Events;
using Pokemon.Domain.AuthenticationAggregates.ValueObjects;

namespace Pokemon.Domain.PocketMonsterAggregate;

public sealed class PocketMonster : AggregateRoot<PocketMonsterId, Guid>, IAuditableEntity
{
        ...
        string sprite)
    {
        ...
        AddDomainEvent(new PocketMonsterUpdated(this));
    }
        ...
        UserId userId)
    {
        ...
        AddDomainEvent(new PocketMonsterTransfered(this, oldUserId!));
    }
